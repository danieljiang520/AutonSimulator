...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=URC+Terrain+Data&box=-110.746041,38.440387,-110.837793,38.368522
...
-----------
  ...
  * URC Terrain Data Height Map (ASTER 30m).png
  ...
  * URC Terrain Data Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * URC Terrain Data Height Map (SRTM3 v4.1).png
  ...
  * URC Terrain Data Height Map (SRTM30 Plus).png
  ...
  * URC Terrain Data Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1310m (actual) is equal to 40m in
