...
MroverSim-Linux-Debug:
	 $(PROJECTBUILD) MroverSim Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSim-Linux-DebugGame:
	 $(PROJECTBUILD) MroverSim Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSim-Linux-Shipping:
	 $(PROJECTBUILD) MroverSim Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSim-Linux-Test:
	 $(PROJECTBUILD) MroverSim Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSim:
	 $(PROJECTBUILD) MroverSim Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSimEditor-Linux-Debug:
	 $(PROJECTBUILD) MroverSimEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSimEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MroverSimEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSimEditor-Linux-Shipping:
	 $(PROJECTBUILD) MroverSimEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSimEditor-Linux-Test:
	 $(PROJECTBUILD) MroverSimEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MroverSimEditor:
	 $(PROJECTBUILD) MroverSimEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
